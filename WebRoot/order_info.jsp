    ...
    var columns = [
		...
		<c:forEach items="${requestScope.orderRooms}" var="orderRoom">
	    	data.push({
	    				...
	    				option:"<a href='queryInnInfo?innId=${orderRoom.inn.innId}'><i class='icon-edit'></i>评论</a>"
	    			});
    	</c:forEach>
