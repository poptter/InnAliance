...
<html>
 ...
 <body>
  <div class="container">
  	<div align="center">
  		<img alt="客栈店家状态分布图" src="<%=basePath%>JFreeChatr\innOrder.jpg">
  	</div>
	<hr>
...
<script type="text/javascript">
  BUI.use(['bui/grid','bui/data'],function (Grid,Data) {
    ...
    var columns = [
            ...
            {title : '操作',dataIndex :'option',width:110}
          ];
      	//默认的数据
		data = [];
		<c:forEach items="${requestScope.orderRooms}" var="orderRoom">
	    	data.push({
	    				...
	    				option:"<a href='<%=basePath%>queryNeedUpdateOrder?orderRoomId=${orderRoom.orderRoomId}'><i class='icon-wrench'></i>修改</a>&nbsp;&nbsp;<a href='<%=basePath%>unsubscribe?orderRoomId=${orderRoom.orderRoomId}'><i class='icon-off'></i>退订</a>"
	    			});
    	</c:forEach>
