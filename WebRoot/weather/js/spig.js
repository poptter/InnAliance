...
jQuery(document).ready(function ($) {
    $("#spig").mousedown(function (e) {
        if(e.which==3){
		showMessage("<iframe name=\"weather_inc\" src=\"http://tianqi.xixik.com/cframe/11\"frameborder=\“0\” scrolling=\"no\" height=\"15px\"  width=\"130px\" allowtransparency=\"true\" ></iframe>",
			"陪我聊天吧！",
			"好无聊哦，你都不陪我玩！",
			"…@……!………",
			"^%#&*!@*(&#)(!)(",
			"我可爱吧！嘻嘻!~^_^!~~",
			"谁淫荡呀?~谁淫荡?，你淫荡呀!~~你淫荡！~~",
			"从前有座山，山上有座庙，庙里有个老和尚给小和尚讲故事……",10000);
}
});
...
jQuery(document).ready(function ($) {
    if (isindex) { //如果是主页
        ...
        if (now > 0 && now <= 6) {
            ...
            showMessage('<marquee direction="left">欢迎来到 <b>客栈联盟</b> !</marquee>', 6000);
        } else {
			showMessage('<marquee direction="left"><font color="#FF0000">' + visitor + '</font>  欢迎来到 客栈联盟 ！</marquee>', 6000);
		}
    }
    else {
